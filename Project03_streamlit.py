...
Amount = st.slider(label="Amount", min_value=0.00, max_value=23691.1, step=0.01) 
V4 = st.slider(label="V4", min_value=-5.00, max_value=16.0,step=0.01)
V5 = st.slider(label="V5", min_value=-113.00, max_value=34.0, step=0.01)
V7 = st.slider(label="V7", min_value=-43.00, max_value=120.0, step=0.01)
V8 = st.slider(label="V8", min_value=-73.00, max_value=20.0, step=0.01)
V12 = st.slider(label="V12", min_value=-18.00, max_value=7.8, step=0.01)
V13 = st.slider(label="V13", min_value=-18.00, max_value=7.8, step=0.01)
V14 = st.slider(label="V14", min_value=-19.00, max_value=10.0, step=0.01)
V17 = st.slider(label="V17", min_value=-25.00, max_value=9.0, step=0.01)
V20 = st.slider(label="V20", min_value=-54.00, max_value=39.0, step=0.01)
V23 = st.slider(label="V23", min_value=-44.00, max_value=22.0, step=0.01)
